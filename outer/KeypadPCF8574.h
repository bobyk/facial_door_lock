...
public:
    ...
    char scan();
    // ДІАГНОСТИКА: друкує сирий байт, прочитаний на кожному з 4 рядків, без
    // жодної інтерпретації через ROW_BIT/COL_BIT/KEYS - для локалізації
    // "1,2,6,9,# не працюють" на рівні голих бітів, коли клавіша утримується.
    void dumpRaw();
